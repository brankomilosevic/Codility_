...
1. Given P = 5 players and C = 3 available courts, the function should return 2. Two games can be played simultaneously 
(for instance, the first and second players can play on the first court, and the third and fourth players on the second court, 
...
int main(void)
{
    int P = 10;
    int C = 1;
    std::cout << "Maximum nuber of games is " << solution(P, C);
    return 0;
}