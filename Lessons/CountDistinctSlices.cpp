...
{
// 100% (need to overview after some time)
      ...
      for (size_t i = 0; i < vLastPos.size()   ; ++i) vLastPos[i] = -1;
      ...
      for (size_t i = 0; i < A.size(); ++i)
      {
         ...
         if (vPrevPos != -1) vNewStart = (vNewStart > vPrevPos ? vNewStart : vPrevPos); // actual start of distinct slice
         vLastPos[vVal] = i;
      }
      return vSlices;
}
