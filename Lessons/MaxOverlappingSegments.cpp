/*
Lesson 16 - Max nonoverlapping segments
...
There is no non-overlapping set with 4 segments.
...
int main()
{
    ...
    cout << "The size of a non-overlapping set containing a maximal number of segments is: " << solution( A, B ) << endl;
