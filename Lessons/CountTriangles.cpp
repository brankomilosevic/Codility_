...
There are 4 triangular triplets that can be constructed from elements of this array, namely (0, 2, 4), (0, 2, 5), (0, 4, 5), and (2, 4, 5).
...
int main(void)
{
  ...
  std::cout << "Number of triangular tripletss is: " << solution(A);
